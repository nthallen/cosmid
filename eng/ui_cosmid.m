...
f = ne_dialg(f, 'add', 0, 1, 'gcosmidpops2', 'POPS2' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2d', 'Drift' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2pn', 'Part Num' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2num_cc', 'num cc' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2s', 'Surface' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2v', 'Volume' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2p', 'P' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2f', 'Flow' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2r', 'Raw ccs' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2t', 'T' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2b', 'Bins' );
f = ne_dialg(f, 'newcol');
f = ne_dialg(f, 'add', 0, 1, 'gcosmidpops2_hk', 'POPS2 HK' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2_hkstd', 'STD' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2_hkldt', 'LD Temp' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2_hkldm', 'LD Mon' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2_hkb', 'Baseline' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2_hks', 'Srvr' );
f = ne_dialg(f, 'add', 1, 0, 'pcosmidpops2_hkstale', 'Stale' );
